...
- **Layer B — GetHook scraper (existing, TO BE extended to multi-page):** runs the normal reliable ad-collection pipeline once per discovered page and files ads under the brand with the page's `page_id`. Not yet wired.
